  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* The Button Body */}
        <div style={{}} className="relative mb-20 overflow-hidden bg-black border border-white/10 w-9 h-9 rounded-full flex items-center justify-center transition-all duration-500 group-hover:border-[rgb(209,167,67)]">
          <ArrowUp 
            size={20} 

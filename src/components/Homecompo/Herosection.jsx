...
//     src: vedio12, 
//     title: "RADIANT RINGS", 
//     subtitle: "Timeless bands crafted to celebrate every moment",
//     ctaText: "SHOP THE RINGS",
//     year: "Collection"
//   },
//   { 
//     src: vedio14, 
...
//             <h1 
//               ref={titleRef}
//               // className="font-playfair text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl text-white font-normal  leading-[0.9]"
//          className="font-playfair text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-6xl text-white font-normal  leading-[0.9]"

//             >
//               {videos[currentVideoIndex].title.split('').map((letter, idx) => (
//                 <span 
//                   key={`${currentVideoIndex}-${idx}`}
//                   className={`inline-block whitespace-pre letter-animation ${animateTitle ? 'letter-visible' : 'letter-hidden'}`}
//                   style={{ 
        ...
        <div className="text-center px-4 sm:px-8 max-w-7xl mx-auto">
          ...
          <div className={`absolute left-4 sm:left-8 top-1/2 -translate-y-1/2 transform transition-all duration-1200 delay-100 ${
            ...
            <div className="relative">
              ...
              <span className="relative font-cormorant text-lg sm:text-xl md:text-2xl text-[rgb(209,167,67)] tracking-widest vertical-rl rotate-180 font-light">
                {videos[currentVideoIndex].year}
              </span>
            </div>
          </div>
          ...
          <div className={`mb-6 md:mb-8 transform transition-all duration-1200 ${
            ...
            <h1 
              ref={titleRef}
              className="font-playfair text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-5xl font-bold leading-[0.9]"
            >
              {videos[currentVideoIndex].title.split('').map((letter, idx) => (
                <span 
                  key={`${currentVideoIndex}-${idx}`}
          ...
          <div className={`relative mb-10 md:mb-16 transform transition-all duration-1200 delay-300 ${
            ...
            <div className="relative">
              ...
              <p className="relative font-cormorant text-base sm:text-lg md:text-xl lg:text-1xl text-white font-light tracking-[0.2em] sm:tracking-[0.25em] md:tracking-[0.3em] uppercase px-6 sm:px-8 md:px-10 py-3 sm:py-4 inline-block">
      ...
      {!isLoaded && (
        <div className="absolute inset-0 flex items-center justify-center bg-black">
          <div className="relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <span className="font-playfair text-xs sm:text-sm text-[rgb(209,167,67)]/60 tracking-widest">FABUNIQO</span>
            </div>
          </div>
        </div>
      )}

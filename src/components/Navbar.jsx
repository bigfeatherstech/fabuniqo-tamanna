...
//     <>
//       {/* Main Navbar */}
//       <nav className="flex items-center justify-between px-12 py-4 bg-gradient-to-b from-[#f7e061d7] to-[#fafafa] border-b border-[rgba(0,0,0,0.08)] shadow-[0_4px_14px_rgba(0,0,0,0.06)] sticky top-0 z-50 animate-slideDown">
//         {/* Left: Menu */}
//         <div className="flex gap-8">
//           <NavLink
//             to="/men"
//             className={({ isActive }) =>
//               `text-lg font-semibold relative transition-all duration-300 text-[#2e2e2e] font-playfair hover:text-[#cdaa53] ${
//                 isActive ? "text-[#cdaa53]" : ""
//               }`
//             }
//           >
//             {({ isActive }) => (
...
//                 Men
//                 {isActive && (
//                   <span className="absolute left-0 bottom-[-4px] w-full h-0.5 bg-gradient-to-r from-[#cdaa53] to-black transition-all duration-400"></span>
//                 )}
//               </>
//             )}
//           </NavLink>
...
//               src={logo}
//               alt="Logo"
//               className="h-11 cursor-pointer transition-transform duration-300 hover:scale-110"
//             />
//           </Link>
//         </div>
...
//               className="py-2 pl-4 pr-10 border-2 border-gray-300 rounded-full outline-none text-sm transition-all duration-300 bg-white font-poppins focus:border-[#cdaa53] focus:shadow-[0_0_6px_rgba(205,170,83,0.5)] focus:scale-102"
//             />
//             <CiSearch className="absolute right-3 text-xl text-gray-600 cursor-pointer transition-all duration-300 hover:text-[#cdaa53] hover:rotate-12" />
//           </div>

//           <CgProfile className="text-2xl cursor-pointer transition-all duration-300 text-gray-800 hover:text-[#cdaa53] hover:scale-110 hover:text-shadow-[0_0_1px_#cdaa53,0_0_1px_#cdaa53]" />
//           <FaRegHeart className="text-2xl cursor-pointer transition-all duration-300 text-gray-800 hover:text-[#cdaa53] hover:scale-110 hover:text-shadow-[0_0_1px_#cdaa53,0_0_1px_#cdaa53]" />
//           <AiOutlineShoppingCart className="text-2xl cursor-pointer transition-all duration-300 text-gray-800 hover:text-[#cdaa53] hover:scale-110 hover:text-shadow-[0_0_1px_#cdaa53,0_0_1px_#cdaa53]" />
//         </div>
//       </nav>
//     </>
//   );
